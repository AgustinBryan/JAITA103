...
public class MagicHat {
    public static void main(String[] args) throws InterruptedException{
        ...
        for(int i = 0; i < (students.length - REST); i++){
            ...
            System.out.printf("Lo studente %s finirà in...", students[i]); //%s indica che è un parametro di tipo stringa
            Thread.sleep(3000);
            String house = null; //una stringa che per il momento non ha un valore (null)
            do{
